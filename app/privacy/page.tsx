  ...
  return (
    <main>
      ...
      <section className="px-6 py-12 max-w-3xl mx-auto text-sm text-gray-700 leading-relaxed">
        ...
        <p className="mb-6">Your information is used solely to connect you with a licensed insurance agent affiliated with Your Future Protection who can provide quotes and coverage options tailored to your needs, to contact you by phone, email, or text regarding your quote request, and to improve our services and website experience. We do not sell, rent, or share your personal information with third parties for marketing purposes unrelated to your insurance inquiry.</p>

        <h2 className="text-lg font-bold text-[#1a3a5c] mb-3">Consent to Contact</h2>
        <p className="mb-6">By submitting your information through our quote form, you provide prior express written consent to be contacted by Your Future Protection and its licensed insurance agents by phone, email, or text message regarding life insurance options. This may include the use of automated telephone dialing systems, prerecorded or artificial voice messages, or SMS text messages. Your consent is not a condition of purchasing any product or service. You may revoke your consent at any time by replying STOP to any text message, by emailing yfpsupport@gmail.com, or by calling (917) 270-3167. Opt-out requests will be processed within 10 business days in accordance with federal TCPA regulations.</p>

        <h2 className="text-lg font-bold text-[#1a3a5c] mb-3">Who Receives Your Information</h2>
        <p className="mb-6">Your information is shared only with licensed insurance agents affiliated with Your Future Protection who will assist you with your coverage options. We may also use third-party service providers (such as email delivery services) to facilitate communication. These providers are bound by their own privacy policies and do not use your data for independent marketing purposes. We do not sell your information to unaffiliated third parties.</p>

        <h2 className="text-lg font-bold text-[#1a3a5c] mb-3">Data Retention</h2>
        <p className="mb-6">We retain your personal information only for as long as necessary to fulfill the purpose for which it was collected, including to provide you with insurance quotes and follow-up services. If you do not purchase a policy, your information will be retained for no longer than 24 months from the date of submission, after which it will be securely deleted. You may request earlier deletion at any time by contacting yfpsupport@gmail.com.</p>

        <h2 className="text-lg font-bold text-[#1a3a5c] mb-3">Data Security</h2>
        <p className="mb-6">We take reasonable measures to protect your personal information from unauthorized access, alteration, or destruction. Our website uses SSL/TLS encryption to protect data transmitted through our forms. However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.</p>
        ...
        <p className="mb-6">You may request access to, correction of, or deletion of your personal information at any time by contacting us at yfpsupport@gmail.com. If you no longer wish to be contacted regarding insurance options, you may opt out by replying STOP to any text, responding to any communication, or contacting us directly. We will honor your request within 10 business days.</p>

        <h2 className="text-lg font-bold text-[#1a3a5c] mb-3">Illinois Residents</h2>
        <p className="mb-6">If you are an Illinois resident, you have the right to request information about the personal data we have collected about you and to request its deletion. To exercise these rights, contact us at yfpsupport@gmail.com. We do not collect biometric information through this website.</p>
