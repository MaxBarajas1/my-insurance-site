...
const steps = [
  ...
  { title: "What is your phone number?", subtitle: "An agent will call you with your options", field: "phone", type: "tel", placeholder: "(555) 000-0000" },
  ...
  if (submitted) {
    return (
      <div className="bg-white rounded-xl p-10 max-w-xl mx-auto text-center shadow-lg">
        ...
        <p className="text-gray-600">A licensed agent will contact you shortly with your personalized quote options.</p>
      </div>
    );
  }
